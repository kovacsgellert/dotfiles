...
winget install --id bambulab.BambuStudio -e --accept-package-agreements --accept-source-agreements
...
winget install --id JonahFintzDEV.CmdPal-RandomDataGenerator -e --accept-package-agreements --accept-source-agreements
winget install --id JiriPolasek.ColorsforCommandPalette -e --accept-package-agreements --accept-source-agreements
winget install --id 15722UsefulApp.WorkspaceLauncherForVSCode -e --accept-package-agreements --accept-source-agreements
...
winget install --id Bruno.Bruno -e --accept-package-agreements --accept-source-agreements
